    ...
    return (
        <div className='relative'>
            <div className='experience flex flex-col gap-2'>
                <div className='flex gap-3 md:justify-end mt-5'>
                    <p className='mt-7 hidden md:block plain text-xl'>20-0ct-2022</p>
                    <Image src={react} className='h-20 w-20 rounded-full ex-border p-2 bg-white '></Image>
                ...
                <div className='flex gap-3 md:justify-end md:flex-row-reverse mt-5'>
                    <p className='mt-7 hidden md:block plain text-xl'>20-0ct-2022</p>
                    <Image src={react} className='h-20 w-20 rounded-full ex-border p-2 bg-white '></Image>
                    <div className='shadow left-card p-5 rounded-lg'>
                        <h3 className='text-3xl plain'>Full Stack</h3>
